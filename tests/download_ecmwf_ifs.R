...
### WARNING: wf_request currently forces NetCDF! Thus, this
### test will always return a NetCDF file and not a grib file.
### NetCDF file works, but of course, the test at the end will
### fail as I am expecting a grib file and not a NetCDF file.
