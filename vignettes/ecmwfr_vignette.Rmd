...
wf_request(email    = "khrdev@outlook.com",   # use keyring option
           transfer = TRUE,                   # wait for request to be finished an download
           path     = "~",                    # store in 'home folder'
           request  = my_request,             # product specification
           verbose  = FALSE)
```
...
wf_request(email    = NULL,        # use ~/.ecmwfapirc file
           transfer = TRUE,        # wait for request to be finished an download
           path     = ".",         # store data to current directory
           request  = my_request,  # request/product specification
           verbose  = FALSE)
```
